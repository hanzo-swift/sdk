...
public struct O11yO11yDeprecatedUser: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(createdAt: Date? = nil, displayName: String? = nil, email: String? = nil, id: String? = nil, isRoot: Bool? = nil, orgId: String? = nil, role: String? = nil, status: String? = nil, updatedAt: Date? = nil) {
...
extension O11yO11yDeprecatedUser: Identifiable {}
