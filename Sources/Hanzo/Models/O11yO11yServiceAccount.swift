...
public struct O11yO11yServiceAccount: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(createdAt: Date? = nil, email: String? = nil, id: String? = nil, name: String? = nil, orgId: String? = nil, status: String? = nil, updatedAt: Date? = nil) {
...
extension O11yO11yServiceAccount: Identifiable {}
