//
// O11yO11yMetricMetadataSaveIn.swift
//
...
public struct O11yO11yMetricMetadataSaveIn: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(description: String? = nil, isMonotonic: Bool? = nil, metricName: String, temporality: String? = nil, type: String? = nil, unit: String? = nil) {
