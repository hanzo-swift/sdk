//
// RegistryWebhookCreateTargetsInner.swift
//
...
public struct RegistryWebhookCreateTargetsInner: Codable, JSONEncodable, Hashable {
    ...
    public init(type: String, address: String, authHeader: String? = nil, skipCertVerify: Bool? = nil) {
        self.type = type
