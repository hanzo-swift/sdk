...
public struct O11yO11yDashboard: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(createdAt: Date? = nil, createdBy: String? = nil, id: String? = nil, image: String? = nil, locked: Bool? = nil, name: String? = nil, orgId: String? = nil, schemaVersion: String? = nil, source: String? = nil, spec: JSONValue? = nil, tags: [O11yO11yDashboardTag]? = nil, updatedAt: Date? = nil, updatedBy: String? = nil) {
...
extension O11yO11yDashboard: Identifiable {}
