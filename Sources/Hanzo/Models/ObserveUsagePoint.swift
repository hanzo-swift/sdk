...
public struct ObserveUsagePoint: Codable, JSONEncodable, Hashable {
    ...
    public init(t: String? = nil, calls: Int64? = nil, tokens: Int64? = nil, costCents: Int64? = nil) {
        self.t = t
        self.calls = calls
        self.tokens = tokens
