...
public struct RiskLabelCoverage: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(contested: Int? = nil, events: Int? = nil, explore: Double? = nil, facts: Int? = nil, from: String? = nil, horizon: Int? = nil, judged: Int? = nil, matured: Int? = nil, pending: Int? = nil, productive: Int? = nil, sources: [RiskSourceCoverage]? = nil, to: String? = nil, unlabelled: Int? = nil, unmatured: Int? = nil, unproductive: Int? = nil) {
