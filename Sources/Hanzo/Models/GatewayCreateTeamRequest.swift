//
// GatewayCreateTeamRequest.swift
//
...
public struct GatewayCreateTeamRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(teamAlias: String? = nil, organizationId: String? = nil, admins: [String]? = nil, members: [String]? = nil, maxBudget: Double? = nil, models: [String]? = nil) {
