...
public struct O11yO11yMetricSummary: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(description: String? = nil, isMonotonic: Bool? = nil, metricName: String? = nil, temporality: String? = nil, type: String? = nil, unit: String? = nil) {
