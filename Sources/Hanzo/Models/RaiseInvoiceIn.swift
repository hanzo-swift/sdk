...
public struct RaiseInvoiceIn: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(currency: String? = nil, customerEmail: String? = nil, lines: [InvoiceLineIn]? = nil, userId: String? = nil) {
