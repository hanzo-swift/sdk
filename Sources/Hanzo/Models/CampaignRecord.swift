...
public struct CampaignRecord: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(audience: String? = nil, budget: Int64? = nil, channels: [ChannelSpec]? = nil, content: [String]? = nil, createdAt: Int64? = nil, id: String? = nil, name: String? = nil, scheduleAt: Int64? = nil, status: String? = nil, updatedAt: Int64? = nil) {
