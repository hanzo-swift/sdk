...
open class HanzoAPIConfiguration: @unchecked Sendable {
    ...
    public init(
        basePath: String = "https://api.hanzo.ai",
    ...
    public static let shared = HanzoAPIConfiguration()
}
...
open class RequestBuilder<T>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: HanzoAPIConfiguration

    /// Optional block to obtain a reference to the request's progress instance when available.
    public var onProgressReady: ((Progress) -> Void)?

    required public init(method: String, URLString: String, parameters: [String: any Sendable]?, headers: [String: String] = [:], requiresAuthentication: Bool, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) {
        self.method = method
