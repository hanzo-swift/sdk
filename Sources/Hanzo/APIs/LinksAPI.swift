...
open class LinksAPI {
    ...
    open class func deleteLinksById(id: String, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> RevokeResp {
        return try await deleteLinksByIdWithRequestBuilder(id: id, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func deleteLinksByIdWithRequestBuilder(id: String, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<RevokeResp> {
        var localVariablePath = "/v1/links/{id}"
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getLinks(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> LinkList {
        return try await getLinksWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getLinksWithRequestBuilder(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<LinkList> {
        let localVariablePath = "/v1/links"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getLinksById(id: String, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> LinkView {
        return try await getLinksByIdWithRequestBuilder(id: id, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getLinksByIdWithRequestBuilder(id: String, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<LinkView> {
        var localVariablePath = "/v1/links/{id}"
        let idPreEscape = "\(APIHelper.mapValueToPathItem(id))"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getLinksDevicesByMachine(machine: String, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> DeviceView {
        return try await getLinksDevicesByMachineWithRequestBuilder(machine: machine, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getLinksDevicesByMachineWithRequestBuilder(machine: String, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<DeviceView> {
        var localVariablePath = "/v1/links/devices/{machine}"
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getLinksRoute(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> RoutePlan {
        return try await getLinksRouteWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getLinksRouteWithRequestBuilder(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<RoutePlan> {
        let localVariablePath = "/v1/links/route"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getLinksUsage(provider: String? = nil, account: String? = nil, window: String? = nil, range: String? = nil, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> BoardResp {
        return try await getLinksUsageWithRequestBuilder(provider: provider, account: account, window: window, range: range, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getLinksUsageWithRequestBuilder(provider: String? = nil, account: String? = nil, window: String? = nil, range: String? = nil, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<BoardResp> {
        let localVariablePath = "/v1/links/usage"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getLinksUsageAccounts(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> AccountsUsage {
        return try await getLinksUsageAccountsWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getLinksUsageAccountsWithRequestBuilder(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<AccountsUsage> {
        let localVariablePath = "/v1/links/usage/accounts"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getLinksUsageSummary(range: String? = nil, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> SummaryResp {
        return try await getLinksUsageSummaryWithRequestBuilder(range: range, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getLinksUsageSummaryWithRequestBuilder(range: String? = nil, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<SummaryResp> {
        let localVariablePath = "/v1/links/usage/summary"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func postLinks(enrollReq: EnrollReq, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> LinkView {
        return try await postLinksWithRequestBuilder(enrollReq: enrollReq, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<LinkView> 
     */
    open class func postLinksWithRequestBuilder(enrollReq: EnrollReq, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<LinkView> {
        let localVariablePath = "/v1/links"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func postLinksDevicesByMachineRevoke(machine: String, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> RevokeResp {
        return try await postLinksDevicesByMachineRevokeWithRequestBuilder(machine: machine, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<RevokeResp> 
     */
    open class func postLinksDevicesByMachineRevokeWithRequestBuilder(machine: String, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<RevokeResp> {
        var localVariablePath = "/v1/links/devices/{machine}/revoke"
        let machinePreEscape = "\(APIHelper.mapValueToPathItem(machine))"
        let machinePostEscape = machinePreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{machine}", with: machinePostEscape, options: .literal, range: nil)
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func postLinksUsage(ingestReq: IngestReq, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> IngestResp {
        return try await postLinksUsageWithRequestBuilder(ingestReq: ingestReq, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func postLinksUsageWithRequestBuilder(ingestReq: IngestReq, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<IngestResp> {
        let localVariablePath = "/v1/links/usage"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
