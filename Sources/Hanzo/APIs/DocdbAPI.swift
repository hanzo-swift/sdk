...
open class DocdbAPI {
    ...
    open class func deleteDocdbByName(name: String, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) {
        return try await deleteDocdbByNameWithRequestBuilder(name: name, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func deleteDocdbByNameWithRequestBuilder(name: String, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<Void> {
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getDocdb(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> [ProvisionedSummary] {
        return try await getDocdbWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getDocdbWithRequestBuilder(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<[ProvisionedSummary]> {
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getDocdbByName(name: String, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> ProvisionedResource {
        return try await getDocdbByNameWithRequestBuilder(name: name, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getDocdbByNameWithRequestBuilder(name: String, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<ProvisionedResource> {
        var localVariablePath = "/v1/docdb/{name}"
        let namePreEscape = "\(APIHelper.mapValueToPathItem(name))"
        let namePostEscape = namePreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{name}", with: namePostEscape, options: .literal, range: nil)
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func postDocdb(provisionRequest: ProvisionRequest? = nil, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> ProvisionResult {
        return try await postDocdbWithRequestBuilder(provisionRequest: provisionRequest, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func postDocdbWithRequestBuilder(provisionRequest: ProvisionRequest? = nil, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<ProvisionResult> {
        let localVariablePath = "/v1/docdb"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
