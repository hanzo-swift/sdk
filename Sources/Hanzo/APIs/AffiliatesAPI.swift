...
open class AffiliatesAPI {
    ...
    /**
     ...
     - returns: AffiliateStanding
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getAffiliates(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> AffiliateStanding {
        return try await getAffiliatesWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - Bearer Token:
       ...
       - name: bearer
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<AffiliateStanding> 
     */
    open class func getAffiliatesWithRequestBuilder(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<AffiliateStanding> {
        ...
        let localVariableRequestBuilder: RequestBuilder<AffiliateStanding>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter apiConfiguration: The configuration for the http request.
     - returns: AffiliateBoard
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getAffiliatesLeaderboard(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> AffiliateBoard {
        return try await getAffiliatesLeaderboardWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - Bearer Token:
       ...
       - name: bearer
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<AffiliateBoard> 
     */
    open class func getAffiliatesLeaderboardWithRequestBuilder(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<AffiliateBoard> {
        let localVariablePath = "/v1/affiliates/leaderboard"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
        ...
        let localVariableRequestBuilder: RequestBuilder<AffiliateBoard>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter apiConfiguration: The configuration for the http request.
     - returns: AffiliateSelf
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getAffiliatesMe(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> AffiliateSelf {
        return try await getAffiliatesMeWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - Bearer Token:
       ...
       - name: bearer
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<AffiliateSelf> 
     */
    open class func getAffiliatesMeWithRequestBuilder(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<AffiliateSelf> {
        let localVariablePath = "/v1/affiliates/me"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
        ...
        let localVariableRequestBuilder: RequestBuilder<AffiliateSelf>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter apiConfiguration: The configuration for the http request.
     - returns: AffiliateEarnings
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getAffiliatesMeEarnings(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> AffiliateEarnings {
        return try await getAffiliatesMeEarningsWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - Bearer Token:
       ...
       - name: bearer
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<AffiliateEarnings> 
     */
    open class func getAffiliatesMeEarningsWithRequestBuilder(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<AffiliateEarnings> {
        let localVariablePath = "/v1/affiliates/me/earnings"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
        ...
        let localVariableRequestBuilder: RequestBuilder<AffiliateEarnings>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter apiConfiguration: The configuration for the http request.
     - returns: AffiliateLinks
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getAffiliatesMeLinks(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> AffiliateLinks {
        return try await getAffiliatesMeLinksWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - Bearer Token:
       ...
       - name: bearer
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<AffiliateLinks> 
     */
    open class func getAffiliatesMeLinksWithRequestBuilder(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<AffiliateLinks> {
        let localVariablePath = "/v1/affiliates/me/links"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
        ...
        let localVariableRequestBuilder: RequestBuilder<AffiliateLinks>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter applyRequest: (body)  
     - parameter apiConfiguration: The configuration for the http request.
     - returns: Application
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func postAffiliatesApply(applyRequest: ApplyRequest, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> Application {
        return try await postAffiliatesApplyWithRequestBuilder(applyRequest: applyRequest, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func postAffiliatesApplyWithRequestBuilder(applyRequest: ApplyRequest, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<Application> {
        let localVariablePath = "/v1/affiliates/apply"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: applyRequest, codableHelper: apiConfiguration.codableHelper)
    ...
    /**
     ...
     - parameter attributeRequest: (body)  
     - parameter apiConfiguration: The configuration for the http request.
     - returns: Attribution
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func postAffiliatesAttribute(attributeRequest: AttributeRequest, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> Attribution {
        return try await postAffiliatesAttributeWithRequestBuilder(attributeRequest: attributeRequest, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - parameter attributeRequest: (body)  
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<Attribution> 
     */
    open class func postAffiliatesAttributeWithRequestBuilder(attributeRequest: AttributeRequest, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<Attribution> {
        let localVariablePath = "/v1/affiliates/attribute"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: attributeRequest, codableHelper: apiConfiguration.codableHelper)
        ...
        let localVariableRequestBuilder: RequestBuilder<Attribution>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter clickRequest: (body)  
     - parameter apiConfiguration: The configuration for the http request.
     - returns: ClickCount
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func postAffiliatesClick(clickRequest: ClickRequest, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> ClickCount {
        return try await postAffiliatesClickWithRequestBuilder(clickRequest: clickRequest, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - parameter clickRequest: (body)  
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<ClickCount> 
     */
    open class func postAffiliatesClickWithRequestBuilder(clickRequest: ClickRequest, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<ClickCount> {
        let localVariablePath = "/v1/affiliates/click"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: clickRequest, codableHelper: apiConfiguration.codableHelper)
        ...
        let localVariableRequestBuilder: RequestBuilder<ClickCount>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter handleRequest: (body)  
     - parameter apiConfiguration: The configuration for the http request.
     - returns: HandleSet
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func postAffiliatesMeHandle(handleRequest: HandleRequest, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> HandleSet {
        return try await postAffiliatesMeHandleWithRequestBuilder(handleRequest: handleRequest, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - parameter handleRequest: (body)  
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<HandleSet> 
     */
    open class func postAffiliatesMeHandleWithRequestBuilder(handleRequest: HandleRequest, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<HandleSet> {
        let localVariablePath = "/v1/affiliates/me/handle"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: handleRequest, codableHelper: apiConfiguration.codableHelper)
        ...
        let localVariableRequestBuilder: RequestBuilder<HandleSet>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter createLinkRequest: (body)  
     - parameter apiConfiguration: The configuration for the http request.
     - returns: LinkMint
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func postAffiliatesMeLinks(createLinkRequest: CreateLinkRequest, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> LinkMint {
        return try await postAffiliatesMeLinksWithRequestBuilder(createLinkRequest: createLinkRequest, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - parameter createLinkRequest: (body)  
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<LinkMint> 
     */
    open class func postAffiliatesMeLinksWithRequestBuilder(createLinkRequest: CreateLinkRequest, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<LinkMint> {
        let localVariablePath = "/v1/affiliates/me/links"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: createLinkRequest, codableHelper: apiConfiguration.codableHelper)
        ...
        let localVariableRequestBuilder: RequestBuilder<LinkMint>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
