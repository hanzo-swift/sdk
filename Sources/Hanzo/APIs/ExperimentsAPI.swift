...
open class ExperimentsAPI {
    ...
    open class func getExperiments(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> ExperimentList {
        return try await getExperimentsWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getExperimentsWithRequestBuilder(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<ExperimentList> {
        let localVariablePath = "/v1/experiments"
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getExperimentsById(id: String, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> Trial {
        return try await getExperimentsByIdWithRequestBuilder(id: id, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getExperimentsByIdWithRequestBuilder(id: String, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<Trial> {
        var localVariablePath = "/v1/experiments/{id}"
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getExperimentsByIdAssign(id: String, subject: String, props: String? = nil, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> Assignment {
        return try await getExperimentsByIdAssignWithRequestBuilder(id: id, subject: subject, props: props, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getExperimentsByIdAssignWithRequestBuilder(id: String, subject: String, props: String? = nil, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<Assignment> {
        var localVariablePath = "/v1/experiments/{id}/assign"
        let idPreEscape = "\(APIHelper.mapValueToPathItem(id))"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getExperimentsHealth(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> Health {
        return try await getExperimentsHealthWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getExperimentsHealthWithRequestBuilder(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<Health> {
        let localVariablePath = "/v1/experiments/health"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func postExperiments(createBody: CreateBody, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> Trial {
        return try await postExperimentsWithRequestBuilder(createBody: createBody, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Trial> 
     */
    open class func postExperimentsWithRequestBuilder(createBody: CreateBody, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<Trial> {
        let localVariablePath = "/v1/experiments"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func postExperimentsByIdAnalyze(id: String, analyzeQuery: AnalyzeQuery, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> Analysis {
        return try await postExperimentsByIdAnalyzeWithRequestBuilder(id: id, analyzeQuery: analyzeQuery, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func postExperimentsByIdAnalyzeWithRequestBuilder(id: String, analyzeQuery: AnalyzeQuery, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<Analysis> {
        var localVariablePath = "/v1/experiments/{id}/analyze"
        let idPreEscape = "\(APIHelper.mapValueToPathItem(id))"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func postExperimentsByIdDecide(id: String, decideBody: DecideBody, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> Trial {
        return try await postExperimentsByIdDecideWithRequestBuilder(id: id, decideBody: decideBody, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Trial> 
     */
    open class func postExperimentsByIdDecideWithRequestBuilder(id: String, decideBody: DecideBody, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<Trial> {
        var localVariablePath = "/v1/experiments/{id}/decide"
        let idPreEscape = "\(APIHelper.mapValueToPathItem(id))"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
