...
open class KbAPI {
    ...
    open class func deleteKbConnectorsByProvider(provider: String, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> ConnectionOut {
        return try await deleteKbConnectorsByProviderWithRequestBuilder(provider: provider, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func deleteKbConnectorsByProviderWithRequestBuilder(provider: String, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<ConnectionOut> {
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getKbConnectors(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> KbConnectorsOut {
        return try await getKbConnectorsWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getKbConnectorsWithRequestBuilder(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<KbConnectorsOut> {
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getKbConnectorsByProviderCallback(provider: String, code: String? = nil, state: String? = nil, error: String? = nil, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> ConnectionOut {
        return try await getKbConnectorsByProviderCallbackWithRequestBuilder(provider: provider, code: code, state: state, error: error, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<ConnectionOut> 
     */
    open class func getKbConnectorsByProviderCallbackWithRequestBuilder(provider: String, code: String? = nil, state: String? = nil, error: String? = nil, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<ConnectionOut> {
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getKbConnectorsByProviderConnect(provider: String, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> KbAuthorizeOut {
        return try await getKbConnectorsByProviderConnectWithRequestBuilder(provider: provider, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getKbConnectorsByProviderConnectWithRequestBuilder(provider: String, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<KbAuthorizeOut> {
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getKbConnectorsCatalog(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> CatalogOut {
        return try await getKbConnectorsCatalogWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getKbConnectorsCatalogWithRequestBuilder(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<CatalogOut> {
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getKbGraph(project: String? = nil, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> GraphOut {
        return try await getKbGraphWithRequestBuilder(project: project, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getKbGraphWithRequestBuilder(project: String? = nil, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<GraphOut> {
        let localVariablePath = "/v1/kb/graph"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func postKbConnectorsByProviderSync(provider: String, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> KbSyncOut {
        return try await postKbConnectorsByProviderSyncWithRequestBuilder(provider: provider, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func postKbConnectorsByProviderSyncWithRequestBuilder(provider: String, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<KbSyncOut> {
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func postKbImport(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) {
        return try await postKbImportWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func postKbImportWithRequestBuilder(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<Void> {
        let localVariablePath = "/v1/kb/import"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func postKbSearch(searchIn: SearchIn, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> SearchOut {
        return try await postKbSearchWithRequestBuilder(searchIn: searchIn, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func postKbSearchWithRequestBuilder(searchIn: SearchIn, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<SearchOut> {
