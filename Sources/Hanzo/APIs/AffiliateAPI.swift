...
open class AffiliateAPI {
    ...
    open class func getAffiliate(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> AffiliateStanding {
        return try await getAffiliateWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getAffiliateWithRequestBuilder(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<AffiliateStanding> {
        let localVariablePath = "/v1/affiliate"
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getAffiliateLeaderboard(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> AffiliateBoard {
        return try await getAffiliateLeaderboardWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getAffiliateLeaderboardWithRequestBuilder(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<AffiliateBoard> {
        let localVariablePath = "/v1/affiliate/leaderboard"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getAffiliateMe(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> AffiliateSelf {
        return try await getAffiliateMeWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getAffiliateMeWithRequestBuilder(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<AffiliateSelf> {
        let localVariablePath = "/v1/affiliate/me"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getAffiliateMeEarnings(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> AffiliateEarnings {
        return try await getAffiliateMeEarningsWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getAffiliateMeEarningsWithRequestBuilder(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<AffiliateEarnings> {
        let localVariablePath = "/v1/affiliate/me/earnings"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getAffiliateMeLinks(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> AffiliateLinks {
        return try await getAffiliateMeLinksWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getAffiliateMeLinksWithRequestBuilder(apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<AffiliateLinks> {
        let localVariablePath = "/v1/affiliate/me/links"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func postAffiliateApply(applyRequest: ApplyRequest, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> Application {
        return try await postAffiliateApplyWithRequestBuilder(applyRequest: applyRequest, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func postAffiliateApplyWithRequestBuilder(applyRequest: ApplyRequest, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<Application> {
        let localVariablePath = "/v1/affiliate/apply"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func postAffiliateAttribute(attributeRequest: AttributeRequest, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> Attribution {
        return try await postAffiliateAttributeWithRequestBuilder(attributeRequest: attributeRequest, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func postAffiliateAttributeWithRequestBuilder(attributeRequest: AttributeRequest, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<Attribution> {
        let localVariablePath = "/v1/affiliate/attribute"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func postAffiliateClick(clickRequest: ClickRequest, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> ClickCount {
        return try await postAffiliateClickWithRequestBuilder(clickRequest: clickRequest, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func postAffiliateClickWithRequestBuilder(clickRequest: ClickRequest, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<ClickCount> {
        let localVariablePath = "/v1/affiliate/click"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func postAffiliateMeHandle(handleRequest: HandleRequest, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> HandleSet {
        return try await postAffiliateMeHandleWithRequestBuilder(handleRequest: handleRequest, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func postAffiliateMeHandleWithRequestBuilder(handleRequest: HandleRequest, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<HandleSet> {
        let localVariablePath = "/v1/affiliate/me/handle"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func postAffiliateMeLinks(createLinkRequest: CreateLinkRequest, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) async throws(ErrorResponse) -> LinkMint {
        return try await postAffiliateMeLinksWithRequestBuilder(createLinkRequest: createLinkRequest, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func postAffiliateMeLinksWithRequestBuilder(createLinkRequest: CreateLinkRequest, apiConfiguration: HanzoAPIConfiguration = HanzoAPIConfiguration.shared) -> RequestBuilder<LinkMint> {
        let localVariablePath = "/v1/affiliate/me/links"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
