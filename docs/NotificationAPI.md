...
```swift
    open class func platformNotificationAll(completion: @escaping (_ data: PlatformTRPCResult?, _ error: Error?) -> Void)
```
...
// List notification channels (admin)
NotificationAPI.platformNotificationAll() { (response, error) in
